...
| `Mount.resolveAll([Def, ResultMessage], ...)`      | Resolves a batch of pending mounts in declaration order. Entries with no pending mount are skipped and do not carry forward.                                                                                                      |
| `Mount.resolveAllExact([Def, ResultMessage], ...)` | Resolves a batch of pending mounts in declaration order. Throws if any entry matches no pending mount or if any pending mount remains unresolved.                                                                                 |
